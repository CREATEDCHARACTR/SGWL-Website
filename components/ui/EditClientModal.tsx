...
const EditClientModal: React.FC<EditClientModalProps> = ({ client, onClose, onSubmit }) => {
    ...
    useEffect(() => {
        if (client) {
            setFormData({
                ...
                location: client.personalInfo.location || '',
                referralSource: client.businessInfo.referralSource || ReferralSource.OTHER,
                notes: client.notes || ''
            });
        }
    }, [client]);
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            onChange={(e) => handleChange('referralSource', e.target.value as ReferralSource)}
